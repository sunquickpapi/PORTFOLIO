            ...
            <header className="page-header">
                ...
                <div className="title-row">
                    ...
                    <h1 className="page-title">
                        Share a New <span className="gradient-text">Passion</span>
                    </h1>
                </div>
                <p className="page-subtitle">Introduce a new drive or hobby to your profile, helping others understand the creative mind behind the work.</p>
            </header>
