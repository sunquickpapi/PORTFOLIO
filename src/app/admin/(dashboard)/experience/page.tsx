...
import { Plus, Edit, Trash2, Briefcase, Sparkles } from "lucide-react";
    ...
    return (
        <div className="experience-wrapper">
            ...
            <header className="page-header">
                ...
                <p className="page-subtitle">Manage your professional journey and career milestones in high definition.</p>
            </header>
                    ...
                    <div className="table-wrapper">
                        <table className="premium-table">
                            ...
                            <tbody>
                                {experience.length === 0 ? (
                                    <tr>
                                        <td colSpan={4} className="empty-cell">No work experience found.</td>
                                    </tr>
                                ) : (
                                    experience.map((e) => (
                                        <tr key={e.id}>
                                            <td>
                                                <div className="cell-primary">{e.company}</div>
                                            </td>
                                            <td>
                                                <div className="cell-secondary">{e.role}</div>
                                            </td>
                                            <td>
                                                <div className="cell-date">{e.duration}</div>
                                            </td>
                                            <td>
            ...
            <style jsx>{`
                ...
                @media (max-width: 768px) {
                    .experience-wrapper { padding: 1.5rem; }
