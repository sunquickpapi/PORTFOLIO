            ...
            <header className="page-header">
                <div className="header-top">
                    <div className="header-badge">
                        ...
                        Credential Refinement
                    </div>
                </div>
                <div className="title-row">
                    <ShieldCheck className="title-icon" size={32} />
                    <h1 className="page-title">
                        Edit <span className="gradient-text">Certification</span>
                    </h1>
                </div>
                <p className="page-subtitle">Refine your official credentials and validation links for professional showcase.</p>
            </header>

            <div className="content-container">
                <CertificationForm certId={id} />
            </div>
